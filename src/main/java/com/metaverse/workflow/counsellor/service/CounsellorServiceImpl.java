...
public class CounsellorServiceImpl implements CounsellorService {
    ...
    public CounsellorRegistrationResponse saveCounseller(CounsllorRegistrationRequest counsellorRequest) {
        ...
        log.info(("saveCounsellorAllotment"));
        CounsellorAllotment allotment=CounsellorAllotmentMapper.map(counsellorRegistration,counsellorRequest);
        counsellorAllotmentRepository.save(allotment);
        counsellorRegistration.setCounsellorAllotments(Arrays.asList(allotment));
        //CounsellorRegistration counsellorRegistration1=CounsellorRegistrationRequestMapper.map(counsellorRequest);
